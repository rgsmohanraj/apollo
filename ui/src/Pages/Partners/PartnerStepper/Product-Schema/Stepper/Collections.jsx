...
import { CollectionsFields } from "../stepper-fields";
...
export const Collections = ({ validated, handleSubmit, formObj, setProductFormObj }) => {
    ...
    const handleChange = (e) => {
        ...
        setcollectionsForm(prev => ({ ...prev, [name]: value }))
    }
    console.log(validated, "Collections-validated")

    useEffect(() => {
        // console.log(collectionsForm)
    }, [collectionsForm]);
                                                            ...
                                                            field.type === "select" ? (
                                                                <Col lg={4}>
                                                                    <SelectComponent
                                                                        {...field}
                                                                        name={field.name}
                                                                        value={collectionsForm[field.name]}
