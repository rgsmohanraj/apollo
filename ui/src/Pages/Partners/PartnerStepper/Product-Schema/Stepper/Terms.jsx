...
import "../style.scss";
import RangePickerComponent from "../../../../../Components/Common/RangePicker";

export const Terms = ({ validated, handleSubmit, formObj, setProductFormObj }) => {
    const [termsForm, settermsForm] = useState({});

    const handleChange = (e) => {
        if (Array.isArray(e)) {
            console.log(e)
            const selectDate = { 'acceptedStartDate': e[0], 'acceptedEndDate': e[1] }
            settermsForm(prev => ({ ...prev, ...selectDate }))
        }
        else {
    ...
    console.log(validated, "Terms-validated")
