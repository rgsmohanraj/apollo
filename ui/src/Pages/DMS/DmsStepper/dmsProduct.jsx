...
import { DMSProductData } from "../mockDMSData";
        ...
        <>
            <div className="product-details">
                <Row>
                    ...
                    <div className="py-3 fs-24 fw-600 color-heading-text d-flex a-center"><Link to="/documents" className="mb-02rem"><DMSArrowLefticon /></Link> <div className="ml-05rem">Documents - Products</div></div>
                    ...
                    <Form layout="vertical">
                        <Col lg="12">
                            <Row>
                                {DMSProductData && DMSProductData.map((field, index) =>
                                    <React.Fragment key={field.key}>
                                        <Col lg="4" className="a-center">
                                        <Link to="/documents/dmsendborrower" className="td-none">
